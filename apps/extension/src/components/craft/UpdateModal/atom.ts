...
export const updatePresetOptionsAtom = atom<({ label: string, value: string })[] | undefined>(undefined);
export const updatePresetAtom = atom<{ label: string, value: string } | undefined>(undefined);
