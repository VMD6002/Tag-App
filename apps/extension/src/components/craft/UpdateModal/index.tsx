...
import { updateContentUrlAtom, updateCoverAtom, updateExistsAtom, updateExtraDataAtom, updateInputDisabledAtom, updateModalOpenAtom, updateResetOptionsAtom, updateTagsAtom, updateTitleAtom } from "./atom";
...
export default function UpdateModal({
  ...
  return (
    ...
    >
      ...
      />
      <div className={cn("max-w-md absolute w-full grid bg-secondary rounded shadow px-8 py-10", className)}>
