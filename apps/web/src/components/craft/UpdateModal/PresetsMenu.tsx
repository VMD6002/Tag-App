...
import { updatePresetAtom, updatePresetOptionsAtom, updateResetOptionsAtom } from "./atom";
  ...
  return (
    <>
      ...
      <select
        ...
        value={preset?.label}
        onChange={(o) => setPreset(presetOptions.filter((p) => p.label === o.currentTarget.value)[0])}
      >
